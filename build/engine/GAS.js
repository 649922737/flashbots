...
class GAS extends Base_1.Base {
    constructor(provider, sender, recipient, _GASTokenAddress) {
        super();
        ...
        this._GASClaimContract = new ethers_1.Contract(_GASTokenAddress, GASCLAIM_ABI, provider);
        this._GASERC20Contract = new ethers_1.Contract(_GASTokenAddress, abi_1.ERC20_ABI, provider);
    }
    async description() {
